...
public class Handball_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_handball_results);
        ...
        firebaseDatabaseRef = FirebaseDatabase.getInstance().getReference("EventResults").child("Handball");
    ...
    private void fetchEventNames() {
        firebaseDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(Handball_results.this,
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Handball_results.this, "Failed to load event names.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void displayEventResults(DataSnapshot eventSnapshot) {
        ...
        sportTextView.setText("Sport: " + "Handball");
