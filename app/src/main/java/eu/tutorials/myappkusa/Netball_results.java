...
public class Netball_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_netball_results);
        ...
        firebaseDatabaseRef = FirebaseDatabase.getInstance().getReference("EventResults").child("Netball");
    ...
    private void fetchEventNames() {
        firebaseDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(Netball_results.this,
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Netball_results.this, "Failed to load event names.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void displayEventResults(DataSnapshot eventSnapshot) {
        ...
        sportTextView.setText("Sport: " + "Netball");
